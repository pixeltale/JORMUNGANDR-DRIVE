...
local motif =
{
	...
	training_info =
	{
		...
		menu_valuename_guardmode_instant = "Instant", --PXN Feature
		menu_valuename_guardmode_pb = "BLUE", --PXN Feature
		...
		menu_valuename_dir_4 = "Backward", --Ikemen feature
		...
		menu_valuename_buttonjam_x = "F", --Ikemen feature
		menu_valuename_buttonjam_y = "E", --Ikemen feature
		menu_valuename_buttonjam_z = "MACRO2", --Ikemen feature
...
function motif.setBaseTrainingInfo()
	...
	motif.training_info.menu_itemname_menutraining_buttonjam = "Buffer Button"
